            ...
            <div class="flex items-center">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center space-x-2 group">
                        ...
                        <span
                             class="text-xl font-semibold text-gray-900 dark:text-gray-100 transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-400"></span> {{-- ADICIONE ESTA LINHA PARA TESTAR --}}
<span class="ml-4 text-red-500 font-bold">Time Atual: {{ Auth::user()->currentTeam->name }}</span> {{--Aqui o título --}}
                    </a>
                </div>
            </div>
